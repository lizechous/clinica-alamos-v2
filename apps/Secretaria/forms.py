...
class CitaMedicaForm(forms.ModelForm): 
    class Meta:  
        model = CitaMedica
        fields = ['run', 'nombre_paciente', 'email','tipo_prevision', 'especialidad', 'medico', 'fecha_cita', 'hora_cita'] 
        ...
        widgets = {
            'run': forms.TextInput(attrs={'class': 'form-control', "onKeyPress": "return soloTeclasRut(event);", "maxlength": "9", "minlength": "7"}), 
